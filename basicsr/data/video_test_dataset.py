...
class VideoTestDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.opt = opt
        #print('opt:',opt)
        self.opt['padding'] = 'reflection_circle'
        self.cache_data = None
        #print('opt[cache_data]:',self.cache_data)
        ...
        print('apt[name]:',opt['name'].lower())
        #add your dataset name
        if opt['name'].lower() in ['userdata','userval','user_data']:
            #print(zip(subfolders_lq,subfolders_gt))
            for subfolder_lq, subfolder_gt in zip(subfolders_lq,
                                                  subfolders_gt):
                # get frame list for lq and gt
                #print('=====================')
                #print('subfolder_lq:',subfolder_lq)
                #print('subfolder_gt:',subfolder_gt)
