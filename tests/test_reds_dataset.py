...
def main(mode='folder'):
    ...
    if mode == 'folder':
        opt['dataroot_gt'] = '/workspace/Data/SR_dataset/REDS/train_sharp/train/train_sharp'
        opt['dataroot_lq'] = '/workspace/Data/SR_dataset/REDS/train_sharp_bicubic/train/train_sharp_bicubic/X4'
